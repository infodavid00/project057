        ...
        <div key={index} className="monthlyranks-card">
          ...
          <div className="monthlyranks-card-catalog">
            <img
              ...
              style={{ marginRight: "-7px", zIndex: 3 }}
            />
            <img
              src={element.images[1]}
              style={{ marginRight: "-7px", zIndex: 2 }}
            />
            <img
              src={element.images[2]}
              style={{ marginRight: "-7px", zIndex: 1 }}
            />
            <img
          ...
          <div style={{ marginTop: "1em" }}>
            ...
            <button className="monthlyranks-card-footer-btn"> Place Bid</button>
          </div>
          {/* section2 */}
        </div>
      ))}
